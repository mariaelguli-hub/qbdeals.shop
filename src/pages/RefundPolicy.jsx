...
export default function RefundPolicy() {
  return (
    <>
      <Helmet><title>Refund Policy — TaxUSA</title></Helmet>
      <section className="py-16 lg:py-24 bg-gray-50 min-h-[60vh]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Contact our support team at support@taxusa.shop with your order details. We process refunds within 3-5 business days.
          </p>

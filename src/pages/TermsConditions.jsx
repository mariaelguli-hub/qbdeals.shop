    ...
    <>
      ...
      <section className="py-16 lg:py-24 bg-gray-50 min-h-[60vh]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            All software licenses sold are genuine and intended for perpetual use on the specified number of devices/users.
          </p>
          <h2 className="text-xl font-bold text-gray-900 mt-6 mb-3">Refund Policy</h2>
          <p className="text-gray-600 leading-relaxed">
            We offer a 30-day money-back guarantee. If your license does not activate, contact us for a full refund.
          </p>
        </div>
      </section>
    </>
